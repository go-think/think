...
func (p *Pipeline) Passable(passable *flow.Request) *Pipeline {
	p.passable = passable
	return p
}
...
func (p *Pipeline) handler(passable *flow.Request, e *list.Element) interface{} {
	if e == nil {
		return nil
	}
...
func (p *Pipeline) closure(e *list.Element) Closure {
	return func(req *flow.Request) interface{} {
		e = e.Next()
